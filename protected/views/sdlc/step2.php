...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Preview Image -->
                <img class="img-responsive" src="<?php echo Yii::app()->baseUrl; ?>/images/900x300_2.jpg" alt="">

                <hr>

                <!-- Post Content -->
                <p class="lead">The analysis phase of the SDLC is where existing system(s) are studied with the aims of designing a new or improved system. In this phase, a number of important decisions are made - including who will work on the system, and the setting of specific performance goals for the system to achieve.</p>
<p>Data must be gathered on the strengths and weaknesses of the existing system by using methods such as:
